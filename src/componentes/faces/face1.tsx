...
const App: React.FC = () => {
  ...
  return (
    <div className="container">
      <Face1 isActive={activeFace === 1} onClick={() => handleFaceClick(1)} />
      <Face2 isActive={activeFace === 2} onClick={() => handleFaceClick(2)} />
      <Face3 isActive={activeFace === 3} onClick={() => handleFaceClick(3)} />
      <Face4 isActive={activeFace === 4} onClick={() => handleFaceClick(4)} />
      <Face5 isActive={activeFace === 5} onClick={() => handleFaceClick(5)} />
      {/* Adicione outros componentes de rosto aqui */}
    </div>
  );
};
